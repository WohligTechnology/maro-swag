...
var models = {
  ...
  uploadFile: function(filename, callback) {
    ...
    writestream.on("finish", function() {
      ...
      fs.unlink(path.join(__dirname, "../../.tmp/uploads/" + filename));
    });

    var imageStream = fs.createReadStream(
    ...
    Password.find().exec(function(err, userdata) {
      if (err) {
        ...
        if (data.filename && data.filename != "") {
          sails.hooks.views.render("user-registration-otp", data, function(
            err,
            body
          ) {
  ...
  emailForResetPassword: function(data, callback) {
    ...
    Password.find().exec(function(err, userdata) {
      if (err) {
        ...
        // console.log("userdata ", userdata);
        if (data.filename && data.filename != "") {
          sails.hooks.views.render("forgot-pwd-emailer", data, function(
            err,
            body
          ) {
            // console.log("body : ", body);
  ...
  emailwelcome: function(data, callback) {
    ...
    Password.find().exec(function(err, userdata) {
      if (err) {
        ...
        // console.log("userdata ", userdata);
        if (data.filename && data.filename != "") {
          sails.hooks.views.render("welcome-emailer", data, function(
            err,
            body
          ) {
            // console.log("body : ", body);
      ...
      if (err) {
        ...
        if (data.filename && data.filename != "") {
          sails.hooks.views.render(
            "confirmed-product-order-emailer",
            data,
            function(err, body) {
              // console.log("body : ", body);
              if (err) {
  ...
  returnedProductEmail: function(data, callback) {
    ...
    Password.find().exec(function(err, userdata) {
      if (err) {
        ...
        // console.log("userdata ", userdata);
        if (data.filename && data.filename != "") {
          sails.hooks.views.render("returned-product-emailer", data, function(
            err,
            body
          ) {
            // console.log("body : ", body);
  ...
  cancelProductEmail: function(data, callback) {
    ...
    Password.find().exec(function(err, userdata) {
      if (err) {
        ...
        // console.log("userdata ", userdata);
        if (data.filename && data.filename != "") {
          sails.hooks.views.render("cancelled-product-emailer", data, function(
            err,
            body
          ) {
            // console.log("body : ", body);
  ...
  deliveredProductEmail: function(data, callback) {
    ...
    Password.find().exec(function(err, userdata) {
      if (err) {
        ...
        // console.log("userdata ", userdata);
        if (data.filename && data.filename != "") {
          sails.hooks.views.render("product-order-delivered", data, function(
            err,
            body
          ) {
            // console.log("body : ", body);
        ...
        writestream.on("finish", function() {
          if (res) {
            ...
            callback(null, {
              name: newFilename,
              url:
                global["env"].realHost + "/api/downloadWithName/" + newFilename
            });
          }
        });
