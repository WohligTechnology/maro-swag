myApp.controller("CheckoutCtrl", function(
  $scope,
  OrderService,
  ProductService,
  toastr,
  ...
  $scope.updateSelection = function(position, paymentWay) {
    ...
    angular.forEach(paymentWay, function(payment, index) {
      if (position != index) payment.checked = false;
    });
  ...
  $scope.registerUser = function() {
    UserService.userRegistration($scope.registerData, function(data) {
      ...
      if (!_.isEmpty(data.data.data)) {
        ...
        toastr.error(
          "User already exists with the given emailId. Please login to proceed",
          "Error"
        );
      }
      {
      ...
      UserService.verifyRegisterUserWithOtp($scope.userData, function(data) {
        ...
        if (data.data.value === true) {
          ...
          if (data.error == "otpNoMatch") {
            ...
            $scope.errorMessage =
              "Error Occurred. Please click on 'Resend OTP'";
            $scope.resendOtpBut = true;
          }
        }
      });
  ...
  $scope.login = function() {
    UserService.login($scope.loginData, function(data) {
      ...
      if (!_.isEmpty(data.data.data)) {
        ...
        $.jStorage.set(
          "accessToken",
          $scope.userData.accessToken[$scope.userData.accessToken.length - 1]
        );
        $.jStorage.set("userId", $scope.userData._id);
        cart.userId = $.jStorage.get("userId");
        cart.accessToken = $.jStorage.get("accessToken");
  ...
  $scope.testFunction = function() {
    OrderService.hdfcPaymentGateway(
      ...
      function(data) {
        ...
        $scope.paymentData = $sce.trustAsHtml(
          '<form id="nonseamless" method="post"name="redirect" action="' +
            global.paymentGatewayURL +
            '"/transaction/transaction.do?command=initiateTransaction" /><input type="hidden" id="encRequest" name="encRequest" value=""><input type="hidden" name="access_code" id="access_code" value="AVRL01EK28AF79LRFA"><script language="javascript">document.redirect.submit();</script></form>'
        );
  ...
  $scope.generateOrder = function(value) {
    ...
    if ($.jStorage.get("discountValues")) {
      ...
      if (data.selectedDiscount.selectedDiscount) {
        if (
          $.jStorage.get("coupon") &&
          data.selectedDiscount.selectedDiscount.discountType ==
          ...
          if (data.data.data) {
            ...
            if (value == "Cash on delivery") {
              ...
              window.location.href =
                adminurl + "Order/formRedirect?orderId=" + $scope.orders._id;
            }
          } else {
            toastr.error(
              "Sorry there was some problem in placing your order",
              "Error"
            );
          }
          angular.element(
            document.getElementById("ordergenerate")
          ).disabled = false;
        });
      } else {
  ...
  CartService.getCart(userData, function(data) {
    if (data.data.data) $scope.orderTable = data.data.data;
    if ($scope.orderTable) {
      console.log("$scope.orderTable.products", $scope.orderTable.products);
      ...
      if ($.jStorage.get("discountValues")) {
        ...
        $scope.grandTotalAfterDiscount =
          discountTypeObjectData.grandTotalAfterDiscount;
        ...
        $scope.grandTotalAfterDiscount = $scope.totalAmountOfOrder =
          _.round($scope.grandTotal) + _.round($.jStorage.get("gst"));
      }

        var gst = 0;
        _.map($scope.orderTable.products, function(product) {
          if (product.product.price > 999) {
            var unitPrice =
              (_.round(product.product.price) * product.quantity * 100) /
              (100 + 12);
        ...
        $scope.gst = gst;
        $.jStorage.set("gst",$scope.gst);

      var cart = {};
      $.jStorage.set("myCart", $scope.orderTable.products);
      cart.product = $scope.orderTable.products;
      cart.userId = $.jStorage.get("userId");
      cart.gst = $scope.gst;
      cart.accessToken = $.jStorage.get("accessToken");
  ...
  if (userData.userId) {
    UserService.getUserDetails(userData, function(data) {
      ...
      $scope.user.deliveryAddress = _.find(
        $scope.user.shippingAddresses,
        function(o) {
  ...
  $scope.setDeliveryAddress = function() {
    if (!$scope.user.deliveryAddress) $scope.user.deliveryAddress = {};
